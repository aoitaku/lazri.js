...
function _r(f) {
  return `<p>${f.filter(({ type: u }) => u === "sentence").map(({ content: u }) => S(u)).join(`<br>
`)}</p>`;
}
function Ur(f) {
  return `<div class="indented section"><p>${f.filter((u) => u.type === "sentence").map(({ content: u }) => S(u)).join(`<br>
`)}</p></div>`;
}
function Xr(f) {
  return `<div data-align="right"><p>${f.filter((u) => u.type === "sentence").map(({ content: u }) => S(u)).join(`<br>
`)}</p></div>`;
}
function S(f) {
...
j.prototype.format = function(f) {
  ...
  if (this.location) {
    ...
    if (r) {
      var w = this.location.end, C = J("", g.line.toString().length, " "), E = r[g.line - 1], p = g.line === w.line ? w.column : E.length + 1, o = p - g.column || 1;
      u += `
 --> ` + m + `
` + C + ` |
` + g.line + " | " + E + `
...
`, re = /^[ ]/, T = /^[^\r\n]/, se = /^[^)\r\n]/, ne = /^[^(\r\n]/, Fe = /^[\\"`\^()%\-]/, Pe = /^[\r\n]/, Re = /^[ \t]/, Be = v("***", !1), je = v("======", !1), Se = v("====", !1), ie = v("==", !1), U = ar(), te = v("=", !1), ke = v("        ", !1), Te = v("                ", !1), fe = P([" "], !1, !1), He = v("    ", !1), Ie = v("``", !1), H = P(["\r", `
`], !0, !1), De = v('""', !1), ae = v("^", !1), le = v("(", !1), ue = v(")", !1), ce = P([")", "\r", `
`], !0, !1), oe = P(["(", "\r", `
`], !0, !1), Ne = P(["\\", '"', "`", "^", "(", ")", "%", "-"], !1, !1), Oe = v("\\", !1), Me = v(`\r
`, !1), Le = P(["\r", `
`], !1, !1), _e = P([" ", "	"], !1, !1), Ue = function() {
  ...
  }, i = 0, I = [{ line: 1, column: 1 }], b = 0, X = [], l = 0, D;
  if ("startRule" in u) {
    if (!(u.startRule in g))
  ...
  function $e() {
    var e;
    return e = k(), e === r && (e = he(), e === r && (e = wr())), e;
  }
  function k() {
    var e, n, s;
    if (e = i, n = [], s = $(), s !== r)
  ...
  function cr() {
    var e, n, s, t;
    return e = i, n = i, l++, s = $(), l--, s === r ? n = void 0 : (i = n, n = r), n !== r ? (f.substr(i, 3) === w ? (s = w, i += 3) : (s = r, l === 0 && c(Be)), s !== r ? (t = _(), t !== r ? e = Xe() : (i = e, e = r)) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function or() {
    var e;
  ...
  function gr() {
    var e, n, s, t;
    return e = i, n = pr(), n !== r ? (s = q(), s !== r ? (t = z(), t !== r ? e = qe(s) : (i = e, e = r)) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function vr() {
    var e, n, s, t, a;
    if (e = i, n = i, l++, s = $(), l--, s === r ? n = void 0 : (i = n, n = r), n !== r)
  ...
  function $r() {
    var e, n, s, t;
    return e = i, n = vr(), n !== r ? (s = q(), s !== r ? (t = z(), t !== r ? e = ze(s) : (i = e, e = r)) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function hr() {
    var e, n, s, t, a;
    if (e = i, n = i, l++, s = $(), l--, s === r ? n = void 0 : (i = n, n = r), n !== r)
  ...
  function dr() {
    var e, n, s, t;
    return e = i, n = hr(), n !== r ? (s = q(), s !== r ? (t = z(), t !== r ? e = Ge(s) : (i = e, e = r)) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function q() {
    var e, n;
    if (e = [], n = de(), n !== r)
  ...
  function be() {
    var e, n, s;
    return e = i, n = i, l++, s = O(), s === r && (s = Ae(), s === r && (s = $())), l--, s === r ? n = void 0 : (i = n, n = r), n !== r ? (f.length > i ? (s = f.charAt(i), i++) : (s = r, l === 0 && c(U)), s !== r ? (n = [n, s], e = n) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function z() {
    var e;
    return e = Ae(), e === r && (e = _()), e;
  }
  function Ae() {
    var e, n, s, t, a, x, G, B;
    if (e = i, n = i, l++, s = $(), l--, s === r ? n = void 0 : (i = n, n = r), n !== r) {
      ...
      if (s !== r) {
        if (t = i, a = i, f.substr(i, 2) === p ? (x = p, i += 2) : (x = r, l === 0 && c(ie)), x !== r) {
          for (G = [], f.charCodeAt(i) === 61 ? (B = o, i++) : (B = r, l === 0 && c(te)); B !== r; )
            G.push(B), f.charCodeAt(i) === 61 ? (B = o, i++) : (B = r, l === 0 && c(te));
          x = [x, G], a = x;
        } else
          i = a, a = r;
        a !== r ? t = f.substring(t, i) : t = a, t !== r ? (a = _(), a !== r ? (n = [n, s, t, a], e = n) : (i = e, e = r)) : (i = e, e = r);
      } else
        i = e, e = r;
    } else
      i = e, e = r;
  ...
  function Ar() {
    var e, n, s;
    if (e = i, n = [], s = me(), s === r && (s = k()), s !== r)
      for (; s !== r; )
        n.push(s), s = me(), s === r && (s = k());
    else
      n = r;
  ...
  function me() {
    var e, n, s;
    return e = i, n = mr(), n !== r ? (s = N(), s !== r ? e = s : (i = e, e = r)) : (i = e, e = r), e;
  }
  function xr() {
    var e, n, s;
    if (e = i, n = [], s = xe(), s === r && (s = k()), s !== r)
      for (; s !== r; )
        n.push(s), s = xe(), s === r && (s = k());
    else
      n = r;
  ...
  function xe() {
    var e, n, s;
    return e = i, n = yr(), n !== r ? (s = N(), s !== r ? e = s : (i = e, e = r)) : (i = e, e = r), e;
  }
  function wr() {
    var e, n, s, t;
  ...
  function N() {
    var e, n, s, t;
    return e = i, n = i, l++, s = he(), s === r && (f.substr(i, 4) === K ? (s = K, i += 4) : (s = r, l === 0 && c(He)), s === r && (s = $())), l--, s === r ? n = void 0 : (i = n, n = r), n !== r ? (s = Cr(), s !== r ? (t = _(), t !== r ? e = Ye(s) : (i = e, e = r)) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function Cr() {
    var e, n;
    if (e = [], n = we(), n !== r)
  ...
  function Er() {
    var e, n, s, t, a;
    if (e = i, n = [], s = A(), s === r && (s = i, t = i, l++, a = M(), l--, a === r ? t = void 0 : (i = t, t = r), t !== r ? (T.test(f.charAt(i)) ? (a = f.charAt(i), i++) : (a = r, l === 0 && c(H)), a !== r ? s = a : (i = s, s = r)) : (i = s, s = r)), s !== r)
      for (; s !== r; )
        n.push(s), s = A(), s === r && (s = i, t = i, l++, a = M(), l--, a === r ? t = void 0 : (i = t, t = r), t !== r ? (T.test(f.charAt(i)) ? (a = f.charAt(i), i++) : (a = r, l === 0 && c(H)), a !== r ? s = a : (i = s, s = r)) : (i = s, s = r));
    else
      n = r;
  ...
  function Fr() {
    var e, n, s, t;
    return e = i, n = M(), n !== r ? (s = Er(), s !== r ? (t = M(), t !== r ? e = er(s) : (i = e, e = r)) : (i = e, e = r)) : (i = e, e = r), e;
  }
  function L() {
    var e, n, s;
  ...
  function Pr() {
    var e, n, s, t, a;
    if (e = i, n = [], s = A(), s === r && (s = i, t = i, l++, a = L(), l--, a === r ? t = void 0 : (i = t, t = r), t !== r ? (T.test(f.charAt(i)) ? (a = f.charAt(i), i++) : (a = r, l === 0 && c(H)), a !== r ? s = a : (i = s, s = r)) : (i = s, s = r)), s !== r)
      for (; s !== r; )
        n.push(s), s = A(), s === r && (s = i, t = i, l++, a = L(), l--, a === r ? t = void 0 : (i = t, t = r), t !== r ? (T.test(f.charAt(i)) ? (a = f.charAt(i), i++) : (a = r, l === 0 && c(H)), a !== r ? s = a : (i = s, s = r)) : (i = s, s = r));
    else
      n = r;
  ...
  function Ce() {
    var e, n, s;
    return e = i, n = i, l++, s = O(), s === r && (s = R(), s === r && (s = $())), l--, s === r ? n = void 0 : (i = n, n = r), n !== r ? (f.length > i ? (s = f.charAt(i), i++) : (s = r, l === 0 && c(U)), s !== r ? e = s : (i = e, e = r)) : (i = e, e = r), e;
  }
  function A() {
    var e, n, s;
  ...
  function $() {
    var e;
    return f.substr(i, 2) === ee ? (e = ee, i += 2) : (e = r, l === 0 && c(Me)), e === r && (Pe.test(f.charAt(i)) ? (e = f.charAt(i), i++) : (e = r, l === 0 && c(Le))), e;
  }
  function y() {
    var e;
  ...
  function Dr() {
    var e, n;
    return e = i, l++, f.length > i ? (n = f.charAt(i), i++) : (n = r, l === 0 && c(U)), l--, n === r ? e = void 0 : (i = e, e = r), e;
  }
  function _() {
    var e;
    return e = $(), e === r && (e = Dr()), e;
  }
  if (D = m(), D !== r && i === f.length)
    return D;
  throw D !== r && i < f.length && c(lr()), ur(
    X,
